...
async def list_work_orders(
    ...
    for row in items_raw:
        ...
        items.append(WorkOrderListResponse(
            ...
            service_job_ids=work_order.service_job_ids,
            additional_service_job_ids=work_order.additional_service_job_ids,
            subtotal_parts=work_order.subtotal_parts,
            subtotal_labor=work_order.subtotal_labor,
            service_jobs_cost=work_order.service_jobs_cost,
            additional_jobs_cost=work_order.additional_jobs_cost,
